...
- **Trang Tin Tức (`news.php`)**: Giao diện lưới đơn giản nhưng đạt hiệu năng tải trang tối đa (lược bớt các hiệu ứng đồ họa nặng).
...
3. Import dữ liệu:
   ...
   - Import file `database/schema.sql` vào database `flcar_db`.
